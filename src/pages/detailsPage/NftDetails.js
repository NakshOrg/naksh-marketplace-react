    ...
    return (
      <>
        ...
        <div style={{ marginTop: 14, ...globalStyles.flexRow }}>
          <div>
            <div style={{ fontSize: 14, opacity: 0.66, marginBottom: 6 }}>
              Artist
            </div>
            <div
              onClick={() => history.push(`/ourartists/${nft?.artist?._id}`)}
              style={{ ...globalStyles.flexRow, cursor: "pointer" }}
            >
              <img
                style={{
                  height: 30,
          ...
          <div style={{ marginLeft: 30 }}>
            ...
            <div
              onClick={() =>
                history.push("/userprofile", { ownerAccountId: nft?.owner_id })
              }
              style={{ ...globalStyles.flexRow, cursor: "pointer" }}
            >
              <img
          ...
          return (
            <>
              <div style={{ marginTop: 13 }}>
                ...
                {item.type === 1 ? (
                  <div
                    onClick={() => helpers.openInNewTab(item.fileUrl)}
                    style={{
                      fontFamily: 200,
                      fontSize: 16,
                      opacity: 0.95,
    ...
    return moreNfts.slice(0, 4).map((nft) => {
      return (
        ...
        >
          <NftCard
            onClick={() =>
              history.push(`/nftdetails/${nft.token_id}`, { replace: true })
            }
        ...
        <Col className={classes.descriptionCol} lg={5} md={5}>
          <div style={globalStyles.flexRowSpace}>
            ...
            <div style={{ display: "flex" }}>
              ...
              <span
                onClick={() => helpers.openInNewTab(googleForm)}
                style={{
                  backgroundColor: "#fff",
                  marginLeft: 15,
                  borderRadius: 100,
          ...
          <div>
            <div style={{ ...globalStyles.flexRow, marginTop: 20 }}>
              <div
                onClick={() => setIsOverviewActive(true)}
                style={{
                  fontWeight: !isOverviewActive ? "400" : "bold",
                  opacity: !isOverviewActive ? 0.7 : 1,
                  fontSize: 12,
                  cursor: "pointer",
                  letterSpacing: 1.5,
                }}
          ...
          {purchasable ? (
            <div className={classes.desktopBtn}>
              <GradientBtn
                ...
                onClick={() =>
                  purchasable && nft?.price ? handleBuyNft() : null
                }
                content={
                  <div>
                    {purchasable && nft?.price
