...
export default function EditProfile(props) {
  ...
  const getArtist = (evm = false) => {
    _getAllArtists({
      wallet: evm ? evmWalletData.address : walletInfo.getAccountId(),
      sortBy: "createdAt",
      sort: -1,
    })
      .then(({ data: { artists } }) => {
  ...
  return (
    <Container fluid className={classes.editContainer}>
      ...
      <div style={{ ...globalStyles.flexRow }}>
        {image ? (
          ...
          <div
            ...
            style={{ ...globalStyles.flexCenter, background: "#14192B" }}
          >
      ...
      <div className={classes.label}>COVER PICTURE</div>
      {coverImage ? (
        buildCoverImgTag()
      ) : (
        <div className={classes.uploadCover}>
          ...
          >
            Lorem ipsum dolor sit amet, aliquam consectetur. (.jpeg, .jpg, .png,
            .gif supported)
          </div>
          <label
            htmlFor="addCoverImg"
